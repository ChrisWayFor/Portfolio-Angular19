 ...
 */
final class Version20241115220834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD category_id INT NOT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD category VARCHAR(100) NOT NULL, DROP category_id');
    }
}
